...
parser.add_argument("--dataset", type=str,
                    choices=["mosi", "mosei"], default="mosei")# mosi
parser.add_argument("--max_seq_length", type=int, default=50)#50
parser.add_argument("--train_batch_size", type=int, default=70)#35, 72
parser.add_argument("--dev_batch_size", type=int, default=128) # 70
parser.add_argument("--test_batch_size", type=int, default=128)
parser.add_argument("--n_epochs", type=int, default=50)#50
parser.add_argument("--dropout_prob", type=float, default=0.2533)#0.5
parser.add_argument(
    "--model",
    type=str,
...
parser.add_argument("--rdrop", type=float, default=0.1)
parser.add_argument("--ct_depths", type=int, default=4)
...
parser.add_argument("--d_l", type=int, default=384)#40
...
parser.add_argument('--temperature', type=float, default=0.1)# mosi-->0.8, mosei-->1.0
...
def prep_for_training(num_train_optimization_steps: int):
    ...
    if args.model == "bert-base-uncased":
            ...
            './BERT_EN/', multimodal_config=multimodal_config, num_labels=1, args = args,
        )
...
def train(
    ...
    for epoch_i in range(int(args.n_epochs)):
        train_loss, train_mm_embeddings, train_labels = train_epoch(model, train_dataloader)
